  ...
  return (
    <div className="h-full mb-64">
      <div className="flex justify-center items-center pt-10">
        <p className="text-4xl">Roadmap</p>
      </div>

      <div className="flex justify-evenly items-center mt-32">
        <div className="flex flex-col border-2 border-black w-96 rounded-lg p-6 bg-black bg-opacity-40">
        ...
        <div className="flex flex-col border-2 border-black w-96 rounded-lg p-6 py-12 bg-black bg-opacity-40">
        ...
        <div className="flex flex-col border-2 border-black w-96 rounded-lg p-6 py-[70px] bg-black bg-opacity-40">
